...
1. Use a password manager to generate and remember all your passwords
   ...
   - The staff at The Developers Institute use [KeePassXC](https://keepassxc.org/) and [1Password](https://1password.com/) as well as [Bitwarden](https://bitwarden.com/). 
   ...
   - LastPass and Bitwarden store encrypted versions of your password on their online server, ( encrypted with your master password ), This allows them to be easily used between multiple computers.
